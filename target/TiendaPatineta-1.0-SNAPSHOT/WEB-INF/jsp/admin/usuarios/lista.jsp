...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>¿Estás seguro de que deseas eliminar el usuario "<span id="usuarioNombre"></span>"?</p>
    ...
    <script>
        function confirmarEliminar(id, nombre) {
            ...
            document.getElementById('btnEliminar').href = '${pageContext.request.contextPath}/admin/usuarios/eliminar?id=' + id;
